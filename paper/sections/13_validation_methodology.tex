...
Group 3); directional separation where the metric is less specific (alignment $\rightarrow$ Group 4); a
null result where the cohort lacks the pathology (vertebral compression $\rightarrow$ Group 1 on a
non-compression cohort); and the harness should catch any metric that points the wrong way (a built-in
bug detector). Section~\ref{sec:results} shows each of these occurred.

...
| **G4** alignment | `c3c7_cobb_angle`, `lordosis_classification`, `segmental_angles`, `posterior_tangent_angle` | `Cobb_C3_C7` (prefers SPINEPS C1) | ✅ **method-valid** (d=0.28, AUC 0.57, p=0.32; J26); production C1 path verified — measurement is accurate, reported as reference value, not a disease discriminator | ✅ |

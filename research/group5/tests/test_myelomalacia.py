...
from research.group5.myelomalacia import detect_cord_signal_abnormality
...
def test_weber_flags_focal_cord_bright_relative_to_csf():
    ...
    from research.group5.myelomalacia import detect_myelopathy_index
...
def test_focal_lesion_caught_by_bright_tail_but_missed_by_median():
    ...
    """
    from research.group5.myelomalacia import detect_focal_hyperintensity

...
named candidate venues. Companion materials cover the technical depth, the quantified non-AI baseline,
...
\textbf{Speed} & Measurements computed in seconds per case (per-component latency measured in the
deployment notes) & Manual caliper measurement of canal, disc, Cobb and vertebral geometry is slow;
...
\end{itemize}
The full manuscript draft is the artifact that would be adapted to a chosen venue's format.

...
\begin{itemize}[leftmargin=*]
  ...
  \item A reproducible threshold-crossing validation on 12 healthy and 10 symptomatic real cervical MRIs
  with non-parametric statistics, showing strong separation for the canal/cord group, directional
  separation for alignment, a correctly null result for the vertebral compression screen on a
  non-compression cohort, and the detection of a real sign-level bug in the disc-height index.

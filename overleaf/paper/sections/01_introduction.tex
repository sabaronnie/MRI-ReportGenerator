...
\begin{center}
\texttt{Input $\rightarrow$ Segmentation $\rightarrow$ Measurements $\rightarrow$ Assessement $\rightarrow$ Report}
\end{center}
...
the structures a radiologist reports on. The assessement layer compares each measurement to a central
...
\begin{itemize}[leftmargin=*]
  ...
  segmentation engines, five measurement groups, and a cited-threshold assessement layer.
...
assessement layer. Section~\ref{sec:valmethod} formalizes the validation methodology and

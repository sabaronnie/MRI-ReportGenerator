...
interpretation layer was wired end-to-end --- the value being not a clean scoreboard but a validation
...
and an interpretation layer whose per-case clinical accuracy still awaits an institutional read. The path

...
\texttt{\{components, measurements, flags, assessements\}}, and the assessement layer wraps each
(measurement $\times$ level) into a container carrying \texttt{status} (\texttt{within\_reference} /
\texttt{outside\_reference} / \texttt{review\_only} / \texttt{not\_assessable}), a per-measurement

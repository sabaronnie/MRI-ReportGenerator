...
\label{app:catalog}
Every measurement key interpreted by Group 6, with its severity bands, unit, tag, and the locked primary-source citation. Reproduced from the finalized cited-threshold catalog. Identifiers are copied verbatim from verified-research notes.
